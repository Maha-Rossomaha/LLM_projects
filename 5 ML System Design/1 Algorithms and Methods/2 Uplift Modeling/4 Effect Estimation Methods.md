...
**Propensity score** $e(X)$ – это условная вероятность treatment при заданных ковариатах:

$$
e(X) = P(W=1 \mid X).
$$

Классическое свойство (Rosenbaum & Rubin):
...
Дальше эти (`ps\_hat`) используются для matching, стратификации или построения весов.
