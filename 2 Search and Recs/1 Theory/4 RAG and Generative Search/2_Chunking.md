...
* Также можно использовать стратегию кластеризации чанков на основе сходства их embedding-векторов. Например, если два последовательных чанка имеют высокую косинусную близость (выше порога $\tau$), они могут быть объединены в один блок. Это позволяет автоматически восстанавливать логические секции документа. Такая стратегия может применяться и на втором уровне иерархии, например при объединении чанков по секциям, главам или смысловым группам.
  ...
  * Пример:
    ...
    Чанки C1 и C2 связаны по теме истории компании, а C3 относится к другой области — информатике. Если косинусная близость между C1 и C2 равна 0.92 и превышает порог $\tau$, а между C2 и C3 равна 0.35 и находится ниже порога, то C1 и C2 объединяются в один блок, а C3 остаётся отдельным.

    Такой подход позволяет автоматически восстанавливать логические секции документа и может применяться на втором уровне иерархии.
---
